          ...
          <div className="px-3 py-2 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              ...
              <span className={`text-xs px-2 py-0.5 rounded-full ${
                wf.status === "running" ? "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300" :
                wf.status === "completed" ? "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300" :
            ...
            <div className="flex gap-3 mt-1 text-xs text-gray-500">
              <span>🤖 {wf.completedAgents}/{wf.totalAgents} agents</span>
            ...
            {wf.stages.map((stage, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`flex-1 ${stage.status === "pending" ? "text-gray-400" : "text-gray-700 dark:text-gray-300"}`}>
                    {stage.stageName}
                  </span>
                  {stage.durationMs ? (
                  ...
                  {stage.costUsd ? (
                    <span className="text-xs text-gray-400">{formatCost(stage.costUsd)}</span>
                  ) : null}
                </div>
              );
            })}
