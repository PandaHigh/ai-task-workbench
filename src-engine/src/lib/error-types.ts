...
export class TaskError extends Error {
  ...
  constructor(
    ...
    opts?: { phase?: string; retryable?: boolean; cause?: Error },
  ) {
    super(message);
    this.name = "TaskError";
...
const TRANSIENT_PATTERNS = [
  ...
  /econnaborted/i, /enoent/i,  // "claude" not found → transient install issue
];

const RATE_LIMIT_PATTERNS = [
  /429/, /rate.?limit/i, /overloaded/i, /capacity/i, /too many requests/i,
];

const QUOTA_PATTERNS = [
  /usage limit/i, /quota exceeded/i, /billing/i,
];
