...
const { ZipArchive } = require("archiver") as {
  ZipArchive: new (opts?: { zlib?: { level: number } }) => Archiver.Archiver;
};

export function streamDirectoryAsZip(dirPath: string, res: ServerResponse, zipFileName: string): Promise<void> {
